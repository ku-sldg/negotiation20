...
\begin{itemize} 
	...
	\item[] $\preceq_A \cdot  \preceq_T = $ selection policy. This is a poset operation. 
	\item[] $E_T =\{e : E | \pi_T(e)\} = $ target's privacy policy
	\item[] $E_A =\{e : E | \pi_A(e)\} = $ appriaser's privacy policy
	\item[] $ E $ is the universe of evidence - all piece of evidence willing to except
