...
hasASPs_dec :: Plc -> System -> ASP -> Prelude.Bool
hasASPs_dec k0 e a =
  list_rec Prelude.False (\a0 _ iHe ->
    let {h = hasASPe_dec k0 a0 a} in
    case h of {
     Prelude.True -> Prelude.True;
     Prelude.False -> iHe}) e
...
knowsOfs_dec :: Plc -> System -> Plc -> Prelude.Bool
knowsOfs_dec k0 s p =
  list_rec Prelude.False (\a _ iHs ->
    let {h = knowsOfe_dec k0 a p} in
    case h of {
     Prelude.True -> Prelude.True;
     Prelude.False -> iHs}) s

executables_dec :: Term -> Plc -> System -> Prelude.Bool
executables_dec t k0 s =
  term_rect (\a k1 s0 -> hasASPs_dec k1 s0 a) (\p _ iHt k1 s0 ->
    let {s1 = iHt p s0} in
    case s1 of {
     Prelude.True -> Prelude.True;
     Prelude.False ->
      let {h = knowsOfs_dec k1 s0 p} in
      case h of {
       Prelude.True -> Prelude.False;
       Prelude.False -> Prelude.True}}) (\_ iHt1 _ iHt2 k1 s0 ->
    let {iHt3 = iHt1 k1 s0} in
    let {iHt4 = iHt2 k1 s0} in
    case iHt3 of {
     Prelude.True -> iHt4;
     Prelude.False -> Prelude.False}) (\_ _ iHt1 _ iHt2 k1 s0 ->
    let {iHt3 = iHt1 k1 s0} in
    let {iHt4 = iHt2 k1 s0} in
    case iHt3 of {
     Prelude.True -> iHt4;
    ...
    case iHt3 of {
     Prelude.True -> iHt4;
     Prelude.False -> Prelude.False}) t k0 s
